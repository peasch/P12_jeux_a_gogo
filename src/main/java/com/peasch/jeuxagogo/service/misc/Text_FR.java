...
public class Text_FR {
    ...
    public static final String ALREADY_USED_GAME_NAME="Ce nom de jeu est déjà utilisé";
    public static final String ALREADY_BORROWED_GAME_NAME="Ce jeu est en cours de location";
    public static final String NOT_FOUND_GAME="Ce jeu n'est pas dans la liste";
    public static final String INCORRECT_INFORMATION="Les informations sont incorrectes";
